...
namespace ColeccionesIndexers
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            animalArray[0].Feed();
            ((Chicken)animalArray[1]).LayEgg();//acceder a métodos de clase específica
            Console.WriteLine();
            Console.WriteLine("Create an ArrayList type collecttion of Animal objects and use it:");
            ...
            animalArrayList.RemoveAt(0);//elimina primer elemento y el ArrayList recorta su tamaño
            ((Animal)animalArrayList[0]).Feed();
